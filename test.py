...
class HealthInst :
    ...
    def __init__(self):
        ...
        self.current_health = jay["imdata"][j]["hcloudCtx"]["children"]["healthInst"]["attributes"]["cur"]
        self.max_sev = jay["imdata"][j]["hcloudCtx"]["children"]["healthInst"]["attributes"]["maxSev"]
